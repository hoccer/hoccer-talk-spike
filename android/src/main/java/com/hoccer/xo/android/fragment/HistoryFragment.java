    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (getArguments() != null && getArguments().getInt(ARG_CLIENT_CONTACT_ID, 0) > 0) {
            ...
            try {
                ...
                mAdapter = new HistoryMessagesAdapter(getListView(), (FlavorBaseActivity) getActivity(), contact);
            } catch (SQLException e) {
            ...
            mAdapter = new HistoryMessagesAdapter(getListView(), (FlavorBaseActivity) getActivity(), mHistoryId);
        }
