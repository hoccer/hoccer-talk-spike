...
public abstract class ProfileFragment extends XoFragment implements IXoContactListener, IXoMessageListener {
    ...
    protected void showMessagingActivity() {
        ...
        if ((mContact.getClientRelationship() == null || mContact.getClientRelationship().isNone() || mContact.getClientRelationship().invitedMe() || mContact.getClientRelationship().isInvited()) && !mContact.isNearby()) {
