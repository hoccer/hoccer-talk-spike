...
public class WorldwideGroupHistoryChatListItem extends ChatListItem implements SearchAdapter.Searchable {
    ...
    public WorldwideGroupHistoryChatListItem(Context context) {
        super(context);
        update();
    }
